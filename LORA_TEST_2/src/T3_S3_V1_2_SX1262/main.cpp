...
/*
Currently has the following error on the Lilygo LoRa Board, right after starting LoRa hardware initialisation:

ESP-ROM:esp32s3-20210327
Build:Mar 27 2021
rst:0x8 (TG1WDT_SYS_RST),boot:0xa (SPI_FAST_FLASH_BOOT)
Saved PC:0x403793a9
  #0  0x403793a9 in _xt_panic at /home/runner/work/esp32-arduino-lib-builder/esp32-arduino-lib-builder/esp-idf/components/esp_system/port/arch/xtensa/panic_handler_asm.S:30
...
int PIN_LORA_RESET = 8;	 // LORA RESET
int PIN_LORA_DIO_1 = 33; // LORA DIO_1
int PIN_LORA_BUSY = 34;	 // LORA SPI BUSY
int PIN_LORA_NSS = 7;	 // LORA SPI CS
int PIN_LORA_SCLK = 5;	 // LORA SPI CLK
int PIN_LORA_MISO = 3;	 // LORA SPI MISO
int PIN_LORA_MOSI = 6;	 // LORA SPI MOSI

int RADIO_TXEN = 15; // LORA ANTENNA TX ENABLE
...
void setup()
{
	...
	init_result = lora_hardware_init(hwConfig); // Code broke here...
