...
#define IMU_CS 5  // Example CS pin for IMU
...
// Web server
WebServer server(80);
const char* imuFile = "/sample.csv";

// Calibration offsets
float calibAccelX = 0, calibAccelY = 0, calibAccelZ = 0;
float calibGyroX  = 0, calibGyroY  = 0, calibGyroZ  = 0;

float  G_range = 4;      // 2/4/8/16/32 g
float  dps_range = 125; // 15.625/31.25/62.5/125/250/500/1000/2000/4000 dps
